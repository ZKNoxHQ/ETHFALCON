...
| ZKNOX_falcon_fused.verify       | NIST, + fused radix-8 NTT, Yul sampler, SWAR norms (solc 0.8.30 via-IR, `optimizer_runs = 1000000`)       | 0.73M | :white_check_mark:|
| ZKNOX_falcon8.verify       | NIST, + eight 32-bit lanes with Montgomery R = 2^16, norm folded into hash-to-point, resident replicated SHAKE lanes, our own Keccak-f[1600] helper (`test/f1600_zknox.hex`, `pythonref/gen_keccak_helper.py`)       | 0.65M | :white_check_mark:|
