...
| ZKNOX_falcon8.verify       | NIST, + eight 32-bit lanes with Montgomery R = 2^16, norm folded into hash-to-point, resident replicated SHAKE lanes (helper `test/f1600_resident.hex`)       | 0.66M | :white_check_mark:|
