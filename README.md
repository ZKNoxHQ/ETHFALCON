...
| Function | Description | gas cost | Tests Status |
|---|---|---|---|
| ZKNOX_falcon_fast.verify | NIST, SHAKE256 via an external Keccak-f[1600] helper | 1.98M | :white_check_mark: |
| ZKNOX_falcon_turbo.verify | NIST, the above + a packed-SWAR NTT core | 1.32M | :white_check_mark: |
| ZKNOX_falcon_fused.verify | NIST, the above + fused radix-8 NTT, Yul hash-to-point sampler, SWAR norms | 0.73M | :white_check_mark: |
| ZKNOX_falcon8.verify | NIST, eight 32-bit lanes with Montgomery R = 2^16, norm folded into hash-to-point, resident SHAKE lanes, own Keccak-f[1600] helper | 0.65M | :white_check_mark: |
