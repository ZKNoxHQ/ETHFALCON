...
#ifdef ALGNAME
    fn_req = "PQCsignKAT_" STR(ALGNAME) "_zknox" ETH_SUFFIX ".req";
#else
    sprintf(fn_req, "PQCsignKAT_%d_zknox" ETH_SUFFIX ".req", CRYPTO_SECRETKEYBYTES);
#endif
...
#ifdef ALGNAME
    fn_rsp = "PQCsignKAT_" STR(ALGNAME) "_zknox" ETH_SUFFIX ".rsp";
#else
    sprintf(fn_rsp, "PQCsignKAT_%d_zknox" ETH_SUFFIX ".rsp", CRYPTO_SECRETKEYBYTES);
#endif
