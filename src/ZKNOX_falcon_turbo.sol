...
// FILE: ZKNOX_falcon_turbo.sol
// ZKNOX_falcon_fast + the packed-SWAR NTT core. Same binding rules.
...
contract ZKNOX_falcon_turbo {
    ...
    function verify(
        ...
        result = falcon_core_packed(s2, ntth, hashed);
        return result;
    }
}
