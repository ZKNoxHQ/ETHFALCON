...
contract ZKNOX_falcon8 {
    ...
    /// @dev the RESIDENT wrapper of the Keccak-f[1600] helper (test/f1600_resident.hex,
    ///      19,417 bytes, generated by pythonref/gen_resident_helper.py around the
    ///      unchanged Fireblocks permutation body): 832 bytes = ignored prefix word +
    ///      25 replicated lanes in, 25 replicated lanes out; the 800-byte clean-lane
    ///      interface of the original stays available
    bytes32 internal constant F1600_CODEHASH = 0x3926a28835d728fc758d2f0a76316ff578c38ab7904974fcbe5b30418fb21337;
