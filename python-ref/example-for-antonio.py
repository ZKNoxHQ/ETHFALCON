...
message = "9700226bec5c6c4802d2f7e21a4d3f80d8dd7ea983b7cf6d040a6066e3c9b1f8"
salt = "f41f1009826c203576ce1e1ed3f27622c0e1cd1a"
# 16e27058fad201c7e463abfc423839bf4a0e8884"
print(len(salt))
...
σ = sk.sign(message.encode(), randombytes=constant_salt, xof=KeccakPRNG)
assert sk.verify(message.encode(), σ, xof=KeccakPRNG)
